...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { email: @clinic.email, name: @clinic.name, phone_number: @clinic.phone_number, website: @clinic.website }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { email: @clinic.email, name: @clinic.name, phone_number: @clinic.phone_number, website: @clinic.website }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
