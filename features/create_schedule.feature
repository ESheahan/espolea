...
Background:
    ...
    Given I log in as "dahrens@berkeley.edu" with "password"
...
Scenario: Forgetting valid data for block
    And I press "Submit Scheduling Block"
    Then I should not be on the schedules listing page
...
Scenario: Trying to edit as an incorrect users
    ...
    And I log in as "notdaniel@gmail.com" with "password"
